/**
 * Created by BlacKICE on 11.05.2015.
 */
...
gulp.task('browsersync', function () {
    browsersync.init({
        ...
        reloadDelay: 0, // Wait for 0 seconds before any browsers should try to inject/reload a file.
...
gulp.task('sass', function () {
    return gulp.src('sass/style.scss')
        ...
        .pipe(gulp.dest(''))
        .pipe(notify({
            message: 'SASS Compile & CSS updated!!!'
        }))
});